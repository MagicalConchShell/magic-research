...
def coordinator(state: ResearchState, config: RunnableConfig) -> Command[Literal["lead_agent", "__end__"]]:
    """Coordinator"""
    ...
    return Command(update={"messages": [AIMessage(content=response.content, name="coordinator")]}, goto=END)
